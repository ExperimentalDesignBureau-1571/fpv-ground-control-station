...
Якщо сигнал складається здебільшого з «реліктового шуму» («снігу»), монітор все ж таки може перейти в режим «синього екрана». У такому випадку можна підключити до блоку керування станцією окуляри через роз'єм XS4 або XS5 або XS6, хоча в них також навряд чи вдасться виокремити корисний сигнал із суцільного шуму.

Постійна поява напису «AV 1 PAL» на фоні сильного шуму — це ознака того, що система працює на максимальній межі. Це сигнал оператору: стабілізація синхронізації мікросхемою AT7456E ще тримається, але в будь-який момент монітор може «впасти» в «синій екран» через перевантаження входу мікросхеми шумами.
