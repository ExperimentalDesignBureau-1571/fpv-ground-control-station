...
| :--- | :--- | :---: |
| Вхідна напруга | АКБ 6S Li-ion/LiPo/LiHV (до 26.1 В) | Живлення через роз'єм XS1 |
...
| Керування VRX | Підтримується | Через Backpack ELRS або через XS3 |
| Інтерфейс TX | Цифровий (диференційний) | XS2 передача телеметрії/даних через звиту пару  |
